...
class WikisControllerTest < ActionController::TestCase
  ...
  test "should create wiki" do
    assert_difference('Wiki.count') do
      post :create, wiki: { body: @wiki.body, image: @wiki.image, private: @wiki.private, title: @wiki.title, user_id: @wiki.user_id }
    end
  ...
  test "should update wiki" do
    patch :update, id: @wiki, wiki: { body: @wiki.body, image: @wiki.image, private: @wiki.private, title: @wiki.title, user_id: @wiki.user_id }
    assert_redirected_to wiki_path(assigns(:wiki))
  end
