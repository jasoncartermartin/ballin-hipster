...
(function() {
  $(function() {
    return $('.chosen-select').chosen({
      ...
      placeholder_text_multiple: 'Add a collaborator...',
      width: '95%'
    });
  });
  ...
  function EpicEditor(options) {
    ...
    var self = this
      ...
      , defaults = { container: 'epiceditor'
        ...
        , theme: { base: '/assets/base/epiceditor.css'
          , preview: '/assets/preview/github.css'
          , editor: '/assets/editor/epic-light.css'
          }
        , focusOnLoad: false
...
var opts = {
  ...
  theme: {
    base: "https://wiki-on-rails.herokuapp.com/assets/themes/base/epiceditor.css",
    preview: "https://wiki-on-rails.herokuapp.com/assets/themes/preview/github.css",
    editor: "https://wiki-on-rails.herokuapp.com/assets/themes/editor/epic-dark.css"
  },
  button: {
    preview: true,
    fullscreen: true,
...
// ** This Javascript has been rendered unnecessary due to Epic Editor
